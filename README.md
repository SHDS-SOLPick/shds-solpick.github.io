...
- 보관함에서 완성한 레시피 목록 확인
  ...
  <table>
    ...
    <tr>
      ...
      <td align="center" height="450">
        <img width="250" alt="1-1_미니게임_인사" src="https://github.com/user-attachments/assets/7fae9f91-ddf0-4b91-ba1b-103ffe299092" />
      </td>
      <td align="center" height="450">
  ...
  <table>
    ...
    <tr>
      <td align="center">팀장 / FE & BE<br/>
        커드 서비스, 미니게임 기능 개발<br/>
      </td>
      <td align="center">팀원 / FE & BE<br/>
        API 통신 및 인증, 함께 요리 기능 개발<br/>
      </td>
      <td align="center">팀원 / FE & BE<br/>
        AI 레시피&식단 추천 기능 개발<br/>
      </td>
      <td align="center">팀원 / FE & BE & 디자인 <br/>
        냉장고 CRUD, 유통기한 알림 기능 개발<br/>       
      </td>
    </tr>
    <tr>
